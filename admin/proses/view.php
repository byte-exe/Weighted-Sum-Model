...
<p><?php 
 pesan('success','<b>PROSES NILAI PERHITUNGAN</b><p>Klik simpan untuk melihat hasil per rangkingan</p> ');
 ?> </p>
...
<thead>
 ...
 <div class="col-md-14">
         <a href="?page=laporan/cetak1" class="btn btn-block bg-green">CETAK</a>
        </div>
