...
<div class="login-box">
  <div class="login-logo">
    <a href="welcome.php"><b>Lupa</b>Password</a>
  </div>
  <!-- /.login-logo -->
        ...
        <!-- Horizontal Form -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Masukan Username dan Key anda</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form id="form1" name="form1" method="post" action="" class="form-horizontal">
              ...
              <div class="box-footer">
                <a class="btn btn-default pull-left" href="login.php">Batal</a>
                <button type="submit" name="button" class="btn btn-info pull-right">Cari</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
        ...
        <div class="box-body">
          <form action="<?php echo $editFormAction; ?>" method="post" name="form2" id="form2">
            <table height="158" align="center">
              <tr valign="baseline">
                <td colspan="2"><div align="center">Silakan Masukan password Baru.<br> 
                  <?= $row_search['Nama']; ?> 
                </div></td>
              </tr>
              <tr valign="baseline">
                <td height="54" colspan="2"><div align="center"><strong>Password Baru</strong></div>
                <input type="password" name="password" value="" size="32" class="form-control" required/></td>
              </tr>
              <tr valign="baseline">
                <td valign="bottom"><input type="submit" value="Ganti Passsword" class="btn btn-primary btn-block"/></td>
                <td valign="bottom"><div align="right"><a href="login.php" class="btn btn-warning">Kembali Login</a></div></td>
              </tr>
            </table>
