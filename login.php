	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(log_asset/images/bgm.jpg);">
				...
				<form class="login100-form validate-form" action="<?php echo $loginFormAction; ?>" method="POST" name="login">
					...
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input class="input100" type="text" value="" name="ngapainpake" placeholder="Masukan username">
						<span class="focus-input100"></span>					</div>

					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						<span class="label-input100">Password</span>
						<input class="input100 form-password" type="password" value="" name="inspecthalaman" placeholder="Masukan password">
						<span class="focus-input100"></span>					</div>
